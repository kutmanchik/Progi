...
int main() {
    ...
    while( cin >> list_lenght) {
        ...
        if(second_list == false) second_list = true;
        else {
            c = a.concatenate(b);
            c.Sort();
            c.display();
...
/**
There are two list LA and LB. Please merge two list into a new list LC and sort the numbers from small to big.
Please try to solve this problem by linked list.
